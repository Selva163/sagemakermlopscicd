...
def handler(event, context):
    ...
    baseline_statistics = model_description["DriftCheckBaselines"]["ModelDataQuality"]["Statistics"]["S3Uri"]
    baseline_constraints = model_description["DriftCheckBaselines"]["ModelDataQuality"]["Constraints"]["S3Uri"]
    
    return {
        "statusCode": 200,
        "ModelUrl": model_url,
        "ImageUri": image_uri,
        "BaselineStatisticsS3Uri": baseline_statistics,
        "BaselineConstraintsS3Uri": baseline_constraints
    }
